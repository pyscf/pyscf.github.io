...
familiar PySCF ``chkfile`` utilities. 
By default, an AGF2 method will inherit the ``chkfile`` attribute of
the underlying Hartree--Fock reference object.
An example of restoring an AGF2 calculation from a checkpoint file can 
be found in :source:`examples/agf2/04-restart.py`:

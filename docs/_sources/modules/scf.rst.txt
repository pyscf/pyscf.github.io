...
* :source:`examples/scf/02-rohf_uhf.py`
* :source:`examples/scf/03-level_shift.py`
* :source:`examples/scf/04-dirac_hf.py`
* :source:`examples/scf/05-breit_gaunt.py`
* :source:`examples/scf/10-glycine.py`
* :source:`examples/scf/11-linear_dep.py`
* :source:`examples/scf/12-fast_newton.py`
* :source:`examples/scf/13-symmetry.py`
* :source:`examples/scf/14-restart.py`
* :source:`examples/scf/15-initial_guess.py`
* :source:`examples/scf/16-h2_scan.py`
* :source:`examples/scf/17-stability.py`
* :source:`examples/scf/20-density_fitting.py`
* :source:`examples/scf/21-x2c.py`
* :source:`examples/scf/22-newton.py`
* :source:`examples/scf/23-decorate_scf.py`
* :source:`examples/scf/24-callback.py`
* :source:`examples/scf/24-tune_diis.py`
* :source:`examples/scf/30-scan_pes.py`
* :source:`examples/scf/31-cr_atom_rohf_tune_init_guess.py`
* :source:`examples/scf/31-v_atom_rohf.py`
* :source:`examples/scf/32-break_spin_symm.py`
* :source:`examples/scf/33-convert_to_dft.py`
* :source:`examples/scf/40-apply_electric_field.py`
* :source:`examples/scf/40-customizing_hamiltonian.py`
* :source:`examples/scf/41-hf_with_given_densityfit_ints.py`
* :source:`examples/scf/42-remove_linear_dep.py`
* :source:`examples/scf/43-custom_get_jk.py`
* :source:`examples/scf/44-soc_ecp.py`
* :source:`examples/scf/50-mom-deltaSCF.py`
* :source:`examples/scf/51-elecoup_mom.py`
* :source:`examples/scf/52-dynamically_control_level_shift.py`
* :source:`examples/scf/53-dynamic_sz.py`
* :source:`examples/scf/54-fractional_occupancy.py`
* :source:`examples/scf/55-overload_convergence_criteria.py`
* :source:`examples/scf/56-h2_symm_breaking.py`
* :source:`examples/scf/70-background_and_hot_tuning.py`
* :source:`examples/scf/71-patch_scf_kernel.py`
